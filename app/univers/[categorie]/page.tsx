...
import UniversClient from "./univers-client";
...
export async function generateMetadata(
  ...
  const content = getUniversContent(category.key);
  const title = `${category.label} — Comment sont fabriqués nos bijoux`;
...
export default async function UniversPage(
  ...
  return <UniversClient categoryKey={category.key} categoryLabel={category.label} />;
}
